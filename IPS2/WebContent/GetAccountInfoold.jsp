...
<tr><td width=74px></td><td height=50px width=380 class="chequeFont underline" style="vertical-align:bottom"><span >Pay to the order of Invoice Payment System Corp.</span></td><td class="chequeFont" style="vertical-align:bottom"> 
...
<tr> <td></td><td colspan=2>
 <table border=0px cellpadding=0 cellspacing=0 style="vertical-align:top;text-align:left"> 
         ...
         <td style="width:60px" class="chequeFont"><h5>Transit Number</h5></td>
         <td style="width:22px"></td>
         <td style="width:60px"><h5>Bank Code</h5></td>
         <td style="width:22px"></td>
         <td style="width:60px"><h5>Account Number</h5></td>
