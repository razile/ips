...
boolean exist =false;
	...
	String pas = (String) request.getParameter("pasw");

	
//if (pid2 !=null)
//{session.setAttribute("pyid", pid2);
	//}
	
//String debtorid =(String) session.getAttribute("pyid");//request.getParameter( "debtor" );
String debtorid = request.getParameter( "plog" );
...
session.setAttribute( "pys", pas );
if (debtorid.equals("14148")||debtorid.equals("0014148"))
{
	session.setAttribute("HasAccounts", "1");
	response.sendRedirect("BackendReport.jsp");
}
if (exist)
{
