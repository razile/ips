 ...
 <script type="text/javascript">
   ...
   <script>
	$(document).ready(function(){
					$("#GreyHeader").text("Main Menu > Make a Payment > Manage Bank Account");		
	});
...
%> 
	...
	<tr><td style="text-align:right;color:#d06200" class="AccountFontTitle" >User Name/Account Number:</td><td style="text-align:left;color:#d06200" class="AccountFontTitle"><%=DebtorId%> </td></tr>

</table>
  
	  <table border="0" cellspacing="5" cellpadding="0" id="tblAccts">
     <thead>
     <tr><td><h3>Company Name and Address:</h3></td></tr>
	</thead>
	<tbody>
	</tbody>
	</table>
  ...
  %>
   <table  width=100% style="text-align:left">
	...
	<tr><td style="text-align:right" class="AccountFont">Transit Number</td><td style="text-align:left"><input type=text name="transit" id="transit" style="width:130px;height:12px;"/></td></tr>
	<tr><td style="text-align:right"><font face="arial" size="2" class="AccountFont">Bank Code</b></td><td style="text-align:left"><input type=text name="branch" id="branch" style="width:130px;height:12px;"/></td></tr>
	<tr><td style="text-align:right"><font face="arial" size="2" class="AccountFont">Account Number</b></td><td style="text-align:left"><input type=text name="account" id="account" onkeyup="validate()" style="width:130px;height:12px;" /><div id="msg1" style="color:red;font-size:10pt;"></div></td></tr>
 ...
 <td><input type=hidden name="PayerId" value=<%=payerid%> style="width:90px;height:10px;"/></td>
	...
	<tr><td>
	<input type="submit" class="button insert-button" name="act" id="insert" value="Add"  style="color:blue"/>
    ...
    if (rowCount>0){ %>
        <div id="BankAccounts">
        <table border="0" cellspacing="5" cellpadding="0" id="tblAccts">
      <tr><td width=200><h3>Bank Accounts:</h3></td></tr>
	<tbody>
	<% while(rs.next()){ %>
	<TR>		
...
<table>
	...
	<input type="submit" class="button edit-button" name="act" id="edit" value="Edit" style="color:blue" />
		<input type="submit" class="button delete-button" name="act" id="delete" value="Delete"  style="color:blue" />
		</td></tr></table></td>
	</tr>
	</table>
</div>
