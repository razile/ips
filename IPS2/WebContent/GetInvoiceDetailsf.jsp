...
id = id.replace("/","");%>
<tr><td colspan=3><h3>&#8470; de confirmation: <%=id %></h3></td></tr>
                         <tr>
                         <td><h3 style="text-align:center">Num&#233;ro de facture</h3></td>
                         <td><h3>Fournisseur</h3></td>
                         <td><h3 style="text-align:right">Montant</h3></td>
                         <td><h3 style="text-align:right">Montant du paiement</h3></td>
                       </tr>
<%! Connection con; %>
