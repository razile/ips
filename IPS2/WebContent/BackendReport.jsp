...
<%@include file='header.jsp'%>
	...
	<form method="post" action="AdminReport_M">
...
<td></td>
<td width="10px"></td>
<td><input type="checkbox" name="approved" id="approved" value="ON"><span class="AccountFont">Approved</span></td>
<td></td>
</tr>
<tr>
<td></td>
<td width="10px"></td>
<td><input type="checkbox" name="declined" id="declined" value="ON"><span class="AccountFont">Declined</span></td>
<td></td>
</tr>
<tr>
<td></td>
<td width="10px"></td>
<td><input type="checkbox" name="deleted" id="deleted" value="ON"><span class="AccountFont">Deleted</span></td>
<td></td>
</tr>
<tr>
<td></td>
<td width="10px"></td>
<td><input type="checkbox" name="submtted" id="submtted" value="ON"><span class="AccountFont">Submitted</span></td>
<td></td>
</tr>
</table>
		</td>
