...
$(document).ready(function() {	
	...
	if ((qs!="null" && qs!="" && qs!="${d}")){
		...
		window.open('DisplayDeletedInvoice.jsp?id='+qs);
...
<tr><td colspan=6 style="margin-left:10px;color:red;font-size:2em;">If you need to change any of the details of your submitted payment, please delete it and go back to Make a Payment.</td></tr>
<tr>
<td></td>
...
--><input type="submit" class="button del-button" name="act" id="delete" value="Delete"  class="act" style="color:blue"/>
</td></tr>
</table>
